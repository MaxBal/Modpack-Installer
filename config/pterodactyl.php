...
return [
    ...
    */
    ...
    'modpacks' => [
        'curseforge' => [
            'enabled' => env('PTERODACTYL_MODPACKS_CURSEFORGE_ENABLED', true),
            'api_key' => env('PTERODACTYL_MODPACKS_CURSEFORGE_API_KEY', ''),
        ],
        'modrinth' => [
            'enabled' => env('PTERODACTYL_MODPACKS_MODRINTH_ENABLED', true),
        ],
        'default_page_size' => env('PTERODACTYL_MODPACKS_DEFAULT_PAGE_SIZE', 50),
    ],
