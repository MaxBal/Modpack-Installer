...
class ServerTransformer extends BaseClientTransformer
{
    ...
    public function transform(Server $server): array
    {
        ...
        return [
            ...
            'modpack_loader' => $this->modpackLoader($server),
    ...
    private function modpackLoader(Server $server): ?string
    {
        $variables = $server->variables
            ->map(fn (EggVariable $variable) => $variable->server_value ?? $variable->default_value ?? $variable->env_variable)
            ->filter()
            ->implode(' ');
