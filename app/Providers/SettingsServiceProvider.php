...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'pterodactyl:modpacks:curseforge:enabled',
        'pterodactyl:modpacks:curseforge:api_key',
        'pterodactyl:modpacks:modrinth:enabled',
        'pterodactyl:modpacks:default_page_size',
    ];
