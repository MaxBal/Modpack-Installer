...
Route::group([
    ...
    Route::group(['prefix' => '/modpacks'], function () {
        ...
        Route::get('/installed', [Client\Servers\ModpackController::class, 'installed']);
        Route::get('/install-status', [Client\Servers\ModpackController::class, 'installStatus']);
        Route::get('/{provider}/{project}/versions', [Client\Servers\ModpackController::class, 'versions']);
        Route::post('/install', [Client\Servers\ModpackController::class, 'install']);
        Route::post('/install/cancel', [Client\Servers\ModpackController::class, 'cancelInstall']);
        Route::delete('/installed', [Client\Servers\ModpackController::class, 'delete']);
    });
