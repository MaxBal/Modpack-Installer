...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::get('/modpacks', [Admin\Settings\ModpacksController::class, 'index'])->name('admin.settings.modpacks');
    ...
    Route::patch('/modpacks', [Admin\Settings\ModpacksController::class, 'update']);
});
